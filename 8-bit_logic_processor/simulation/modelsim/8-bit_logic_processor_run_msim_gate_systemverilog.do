...
vlog -sv -work work +incdir+. {8-bit_logic_processor.svo}
...
vsim -t 1ps -L altera_ver -L altera_lnsim_ver -L fiftyfivenm_ver -L gate_work -L work -voptargs="+acc"  logic_processor_8_bit_testbench
